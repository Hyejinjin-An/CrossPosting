...
function SourcePostCard() {
  return (
    <WorkflowStepCard step={1} title="원본 게시물">
      <div className="mb-3 flex aspect-square w-full items-center justify-center rounded-md bg-muted">
  ...
  return (
    <WorkflowStepCard step={2} title="채널별 초안">
      <div className="space-y-3">
        ...
        <div className="rounded-md border border-border p-3">
          <div className="mb-2 flex items-center justify-between">
            <span className="text-xs font-semibold text-foreground">KakaoStory</span>
    ...
    <WorkflowStepCard step={3} title="발행 상태">
      <div className="space-y-3">
        <div className="flex items-center justify-between rounded-md bg-muted px-3 py-2.5">
          ...
          <span className="text-[10px] font-medium text-primary">발행 완료</span>
        </div>
        <div className="flex items-center justify-between rounded-md bg-muted px-3 py-2.5">
          <div className="flex items-center gap-2">
            <CheckCircle2 className="h-4 w-4 text-muted-foreground" />
            <span className="text-xs text-foreground">KakaoStory</span>
          </div>
          <span className="text-[10px] font-medium text-muted-foreground">패키지 준비</span>
        </div>
        <div className="mt-2 rounded-md border border-border p-3 text-[11px] text-muted-foreground">
          <span className="font-semibold text-foreground">게시 이력</span>
          <br />
          무엇을 어디에 올렸는지
          <br />
          한 화면에서 확인합니다.
